...
class Vector_DB:
    def __init__(self, persist_directory='/Users/amycweng/DH/SERMONS_APP/db/data/vectordb'):
    ...
    def search_bible(self, query,k=10):
        results = self.bible.query(query_texts= [query], n_results= k)
        ret = []
